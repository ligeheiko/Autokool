...
namespace Autokool.Tests.SoftTests.Pages
{
    ...
    public class CourseWebPageTests : BaseWebPageTests
    {
        protected override List<string> expectedUrl
            => new() { "/Administrator/Courses/Index?handler=index", "/Student/Courses/Index?handler=index" };

        protected override string expectedHtml => "<h1>Courses</h1>";
        protected override string pageName => "Courses";
        [TestMethod]
