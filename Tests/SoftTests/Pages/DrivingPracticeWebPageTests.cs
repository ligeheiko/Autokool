...
{
    [TestClass]
    public class DrivingPracticeWebPageTests : BaseWebPageTests
    {
        protected override List<string> expectedUrl
          => new() { "/Administrator/DrivingPractices/Index?handler=index", "/Student/DrivingPractices/Index?handler=index" };

        protected override string expectedHtml => "<h1>Driving practices</h1>";
        protected override string pageName => "DrivingPractices";
        [TestMethod]
